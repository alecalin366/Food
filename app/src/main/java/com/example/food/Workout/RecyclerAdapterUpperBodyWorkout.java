...
import static com.example.food.Workout.VideoUpperBodyWorkout.VideoID;


public class RecyclerAdapterUpperBodyWorkout extends RecyclerView.Adapter<RecyclerAdapterUpperBodyWorkout.VideoInfoHolder> {
