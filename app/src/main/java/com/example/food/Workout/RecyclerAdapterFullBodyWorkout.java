...
import static com.example.food.Workout.VideoFullWorkout.VideoID;


public class RecyclerAdapterFullBodyWorkout extends RecyclerView.Adapter<RecyclerAdapterFullBodyWorkout.VideoInfoHolder> {
