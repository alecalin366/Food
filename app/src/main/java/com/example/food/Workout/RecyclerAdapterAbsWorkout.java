...
import static com.example.food.Workout.VideoAbsWorkout.VideoID;


public class RecyclerAdapterAbsWorkout extends RecyclerView.Adapter<RecyclerAdapterAbsWorkout.VideoInfoHolder> {
