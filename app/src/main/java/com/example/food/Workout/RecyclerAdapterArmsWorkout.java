...
import static com.example.food.Workout.VideoArmWorkout.VideoID;


public class RecyclerAdapterArmsWorkout extends RecyclerView.Adapter<RecyclerAdapterArmsWorkout.VideoInfoHolder> {
