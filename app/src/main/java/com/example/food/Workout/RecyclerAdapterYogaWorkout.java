...
import static com.example.food.Workout.VideoYogaWorkout.VideoID;


public class RecyclerAdapterYogaWorkout extends RecyclerView.Adapter<RecyclerAdapterYogaWorkout.VideoInfoHolder> {
