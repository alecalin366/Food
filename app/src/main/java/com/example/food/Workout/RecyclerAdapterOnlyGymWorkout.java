...
import static com.example.food.Workout.VideoOnlyGymWorkout.VideoID;


public class RecyclerAdapterOnlyGymWorkout extends RecyclerView.Adapter<RecyclerAdapterOnlyGymWorkout.VideoInfoHolder> {
