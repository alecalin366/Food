...
public class PhotoFragment extends Fragment {
    ...
    public void startCameraButton(View view){
        btnLaunchCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(((SelectPhotoActivity)getActivity()).getCurrentTabNumber() == PHOTO_FRAGMENT_NUM){
                    if(((SelectPhotoActivity)getActivity()).checkPermissions(Permissions.CAMERA_PERMISSION[0])){
    ...
    private boolean isRootTask(){
        if(((SelectPhotoActivity)getActivity()).getTask() == 0){
            return true;
        }
        else{
            return false;
