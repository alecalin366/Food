      ...
      setContentView(R.layout.activity_startup1);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StartupActivity1.this, StartupActivity2.class);
                startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(StartupActivity1.this).toBundle());
            }
        });
  }
}